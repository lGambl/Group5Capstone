namespace StudyDesk.View
{
    partial class SourceForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            videoControl1.Size = new Size(699, 547);
            ...
            notesFlowLayoutPanel.AutoSizeMode = AutoSizeMode.GrowAndShrink;
            notesFlowLayoutPanel.Dock = DockStyle.Fill;
            notesFlowLayoutPanel.FlowDirection = FlowDirection.TopDown;
            notesFlowLayoutPanel.Location = new Point(0, 0);
            notesFlowLayoutPanel.Name = "notesFlowLayoutPanel";
            notesFlowLayoutPanel.Size = new Size(315, 547);
            notesFlowLayoutPanel.TabIndex = 0;
            notesFlowLayoutPanel.WrapContents = false;
            // 
            // SourceForm
            // 
